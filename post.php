            ...
            <form method="post" onsubmit="setSelected()">
                <table>
                    ...
                    <tr>
                        <td>
                           <?php
                                $sql = "SELECT * FROM discussion_topics A JOIN discussion_posts B ON A.topicID=B.topicID JOIN discussion_quotes C ON B.postID=C.postID WHERE C.approvalStatus=0 ORDER BY A.topicID";
                                $result = mysqli_query($conn,$sql);
