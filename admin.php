        	...
        	<div class="content_box" style="height : 550px; overflow-x:   scroll;overflow-y: auto;" id="search">
                    <?php
                        ...
                        if(mysqli_num_rows($result)>0) {
                            echo '<table><tr>';
                            echo '<td style="font-size:18px;padding-bottom:10px;" colspan="3">Chief Manager</td></tr><tr><td ><img class="image_wrapper image_fl"  width="140px" height="160px" src="images/profile/1517.jpg" alt="Image 1" /><a href="employeeProfile.php?empID=1517" target="_blank" ><b>Dr.Suresh Babu.D.S <br />Scientist F & Chief Manager (In-charge)</b></a></td></tr><tr>';
                            $row=mysqli_fetch_array($result);
                            $last = $row['divisionName'];
                             echo '<td style="font-size:18px;padding-bottom:10px;" colspan="3">' . $row['divisionName'] . '</td></tr><tr><td ><img class="image_wrapper image_fl"  width="140px" height="160px" src="images/profile/'.$row['employeeCode'] . '.jpg" alt="Image 1" /><a href="employeeProfile.php?empID=' . $row['employeeCode'] . '" target="_blank" ><b>' . $row['employeeName'] .'<br />' . $row['designation']. '</b></a></td>';
                             $i++;
