...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        	...
        	<div id="templatemo_menu">
                <ul>
                  <li><a href="index.php" target="_parent">Home</a></li>
                    ...
                    <li><a href="announcements.php" target="_parent"  class="current">Notice Board</a></li>
        ...
        <div id="templatemo_content" style="overflow-y: scroll;min-height:750px;" >
            <?php
                $sql = "SELECT title,filename,DATE_FORMAT(updatedOn,'%d-%m-%Y') as last FROM noticeboard order by updatedOn DESC";
                $result = mysqli_query($conn,$sql);
                            if(mysqli_num_rows($result)>0) {
                                while ($row = mysqli_fetch_array($result)) {
                                    echo '<div class="content_box" style="padding-bottom: 5px;padding-top: 0px;">';
                                    echo '<a style="font-size:14px;" href="documents/' . $row['filename'] .'" target="_blank">' . $row['title'] . '</a></div>';
                                }
                            }
                        ?>
