...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
            ...
            <?php
                $sql = "SELECT *,COUNT(postID) as comments_no FROM discussion_topics A LEFT JOIN (SELECT postID,topicID,) B ON A.topicID=B.topicID WHERE status=1";
                $res = mysqli_query($conn,$sql);
                if(mysqli_num_rows($res)>0) {
                    while($data = mysqli_fetch_array($res)) {
                        echo '<div class="content_box" ><h5>'.$data['title'] .'</h5></a>
                <p>'.$data['topic'].'</p><br /><span align="right"><a href="">'.$data['comments_no'].' Comments</a></span></div>';
                    }
                }
            ?>
