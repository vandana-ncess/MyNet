...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
        	...
        	<div style="padding-left: 20px;padding-top: 50px;overflow-y: scroll;min-height:650px;" >
                <div style='float: left;width:300px;'>
            	<?php
                            echo '</table>';
                            $sql = "SELECT * FROM rac_meetings where year=" . $yr;
                            $result = mysqli_query($conn,$sql);
                            if(mysqli_num_rows($result)>0) {
                                echo '<table  id="tblDocument">';
                                while($row=mysqli_fetch_array($result)) {
                                    echo '<tr><td><a href="documents/rac' . $row['fileName'] . '" target="_blank" ><h5>' . $row['title'] .'</h5><img class="image_wrapper image_fl" src="images/pdf.ico" alt="Image 1" /></a></td>';
                                        echo '</tr>';
                                } echo '</table>';
                            }
                ?>
