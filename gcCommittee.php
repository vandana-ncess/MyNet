...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
            ...
            <a href="gc.php" style="float: right;padding-top: 10px;padding-right: 5px;font-size: 14px;"><input type="button" value="Agenda & Minutes" style="width: 200px;cursor: pointer;" /></a>
