...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main" style="width: 984px;"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content"  style="margin-left: 50px;float: left;">
            <h4>ONGOING PLAN PROJECTS OF NCESS (2017-20)</h4>
            ...
            <button class="accordion" style="margin-top:20px;">Coastal Processes (CoP) Group</button>
            <div class="panel">
             <?php
                $sql = "SELECT * FROM main_projects A JOIN projects B ON A.mainPjctID = B.mainPjctID  "
            ...
            <button class="accordion"  style="margin-top:20px;">Atmospheric Processes (AtP) Group</button>
            <div class="panel">
              <?php
                $sql = "SELECT * FROM main_projects A JOIN projects B ON A.mainPjctID = B.mainPjctID  "
             ...
             <button class="accordion"  style="margin-top:20px;">Hydrological Processes (HyP) Group</button>
            <div class="panel">
              <?php
                $sql = "SELECT * FROM main_projects A JOIN projects B ON A.mainPjctID = B.mainPjctID  "
