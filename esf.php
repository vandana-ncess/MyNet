...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        	...
        	<div id="templatemo_menu">
                <ul>
                  <li><a href="index.php" target="_parent">Home</a></li>
                    ...
                    <li><a href="esf.php" target="_parent"  class="current">ESF</a></li>
        ...
        <div id="templatemo_content" style="overflow-y: scroll;">
            <div>
                <h4 style="color: blue;font-size: 20px;"><u>Lecture Series</u></h4>
            <?php
                            $sql = "SELECT * FROM esf ORDER BY updatedOn DESC";
                            $result = mysqli_query($conn,$sql);
                            if(mysqli_num_rows($result)>0) {
                                while ($row = mysqli_fetch_array($result)) {
                                   echo '<div class="content_box" style="padding-bottom: 2px;padding-top: 2px;">';
                                    echo '<table style="font-size:14px;"><tr><td>Title</td><td>' . $row['title'] . '</td></tr><tr><td>Speaker</td><td>' . $row['speaker'] . '</td></tr>';
                                    echo '<tr><td width="120px">Date & Venue</td><td>'. $row['date']. '</td></tr></table></div>';
                                }
                            }
                        ?>
            </div>
