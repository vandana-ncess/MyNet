    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
            <ul class="breadcrumb" style="padding-top: 2px;">
                ...
                <li><a href="gc.php">Governing Council</a></li>
                <li><?php echo $yr; ?></li>
            </ul>
        	<div  style="padding-top: 50px;padding-left: 20px;overflow-y: scroll;min-height:650px;" >
                <div style='float: left;width:300px;'>
                    <?php
                    $sql = "SELECT * FROM gc_meetings where year=" . $yr;
                            $result = mysqli_query($conn,$sql);
                            if(mysqli_num_rows($result)>0) {
                                echo '<table>';
                                while($row=mysqli_fetch_array($result)) {
                                    echo '<tr><td><a href="documents/gc/' . $row['fileName'] . '" target="_blank" > <img class="image_wrapper image_fl" src="images/pdf.ico" alt="Image 1" /><h5>' . $row['title'] .'</h5></a></td>';
                                    echo '</tr>';
