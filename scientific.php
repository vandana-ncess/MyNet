    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        ...
        <div id="templatemo_content">
            <ul class="breadcrumb" style="padding-top: 2px;">
                ...
                <li>Scientific Support Staff</li>
            </ul>
        	...
        	<div class="content_box" style="height : 550px; overflow-x:   scroll;overflow-y: auto;" id="search">
                    <?php
                        ...
                        $sql = "SELECT A.*,designation,divisionName FROM employee A JOIN designation B ON A.designationID=B.designationID JOIN division C "
                                . " ON A.divisionID = C.divisionID where A.categoryID=3 AND employeeStatus=1 ORDER BY divisionID,level,joining_date";
                            ...
                            $last = $row['divisionName'];
                             ...
                             while($row=mysqli_fetch_array($result)) {
                               if($last == $row['divisionName']) {
                                   ...
                                   echo '<tr><td colspan="3" style="font-size:17px;padding-bottom:10px;padding-top:10px;width:450px;">' . $row['divisionName'] . '</td></tr><tr>';
                                   $i = 1;
...
<script>
    ...
    <script type="text/javascript">
        function search() {
            ...
            var uri = "getStaff.php?category=scientific&str="+ $str;
