        ...
        <div id="templatemo_content">
            <div class="content_box" style="padding-top: 10px;">
                <form method="post" action="" onsubmit="validateForm(event)"><fieldset>
                    ...
                    <tr>
                        <td >From Date</td><td style="padding-left: 10px;"><input type="date" name="datepicker1" id='datepicker1'  style="width:170px;height: 18px;"   > </input></td>
                        <td style="padding-left: 10px;">To Date</td><td style="padding-left: 10px;"><input type="date" name="datepicker2" id='datepicker2'   style="width:182px;height: 18px;"  /></td>
