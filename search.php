                 ...
                 <?php
                        ...
                        if(mysqli_num_rows($result)>0) {
                            ...
                            while($row=mysqli_fetch_array($result)) {
                                echo '<td><a href="documents/circulars/' . $row['fileName'] . '" target="_blank" ><h5>' . $row['title'] .'</h5><img class="image_wrapper image_fl" src="images/file.ico" alt="Image 1" /></a></td>';
                                if(($i%5)==0)
                                    echo '</tr><tr>';
                        ...
                        $sql = "SELECT * FROM court_orders";
                        $result = mysqli_query($conn,$sql);
                        if(mysqli_num_rows($result)>0) {
                            while($row=mysqli_fetch_array($result)) {
                                echo '<td><a href="documents/courtorder/' . $row['fileName'] . '" target="_blank" ><h5>' . $row['title'] .'</h5><img class="image_wrapper image_fl" src="images/file.ico" alt="Image 1" /></a></td>';
                                if(($i%5)==0)
                                    echo '</tr><tr>';
