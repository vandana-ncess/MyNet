...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main"><span id="main_top"></span><span id="main_bottom"></span>
        	...
        	<div id="templatemo_menu">
               <ul>
                  <li><a href="index.php" target="_parent">Home</a></li>
                    ...
                    <li><a href="eGovernance.php" target="_parent" class="current">e-Governance</a></li>
        ...
        <div id="templatemo_content">
        		<div class="content_box" style="padding-bottom: 140px;padding-top: 20px;">
                <div style='float: left;width:300px;' >
                    <a href="https://ncess.eoffice.gov.in/"  target="_parent"><h5>eOffice</h5><img class="image_wrapper image_fl" src="images/eoffice.png" alt="Image 1" /></a>
                
                
                </div><div style='float: right;width:300px;'>
                    <a href="https://eprocure.gov.in/cppp/"><h5>Central Public Procurement Portal</h5><img class="image_wrapper image_fl" src="images/cppp.png" alt="Image 1" /></a>
                
               
              </div>
          </div>
            <div class="content_box" style="padding-bottom: 140px;padding-top: 30px;">
                <div style='float: left;width:300px;'>
                  <a href="https://gem.gov.in/" target="_parent"> <h5>GeM</h5><img class="image_wrapper image_fl" src="images/gem.svg" alt="Image 1" /></a>
               
              </div>  <div style='float: right;width:300px;'>
                  <a href="http://ncesskl.attendance.gov.in/" target="_parent"><table><tr><td style="float: top;vertical-align: top;width: 60px;"><h5 >AE-BAS</h5></td><td style="width: 200px;"><img class="image_wrapper image_fl" src="images/logo.png" alt="Image 1" /></td></tr></table></a>
                
                
                </div>
          </div>
            
           <div class="content_box" style="padding-bottom: 170px;padding-top: 30px;">
                <div style='float: left;width:300px;'>
                    <a href="#"><h5>Virtual Class Room</h5><img class="image_wrapper image_fl" src="images/vc.jpg" alt="Image 1" /></a>
                
              
          </div> <!--<div style='float: right;width:300px;' >
              <a href="consultant.php"  target="_parent"><h5>Senior Consultants</h5><img class="image_wrapper image_fl" src="images/consultant.png" alt="Image 1" /></a>
